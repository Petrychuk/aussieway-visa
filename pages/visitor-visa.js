...
export default function VisitorVisasPage({ intro, detailsHtml }) {
  return (
    <>
      <Intro {...intro} />
      <Breadcrumbs />
...
export async function getStaticProps() {
  const intro = await getIntroContent('visitor-visa');
  const detailsHtml = await getVisaDetails('visitor_visa_details');
